...
app.post('/webhook', validateRequest, async (req, res) => {
  ...
  try {
    ...
    async function contactarWhatsApp(agent) {
      ...
      agent.add('👥 **WhatsApp:** +57 320 890 0000'); // Reemplaza con tu número real
      agent.add('🔗 **Enlace directo:** https://wa.me/573208900000'); // Reemplaza con tu enlace real
