...
app.post('/webhook', (request, response) => {
  ...
  async function handleDeepseekQuery(agent) {
    ...
    const knowledgeBaseContext = `
      ...
      - Horarios de atención: Lunes a Viernes de 9am a 6pm.
      - Política de devoluciones: Se aceptan devoluciones hasta 30 días después de la compra.
      - Productos principales: Electrónicos, ropa y artículos para el hogar.
      ---
